...
bot = telebot.TeleBot('7305763465:AAEjWvQsBj2WiNVw6jBXIWR0cooKJDGMg1Q')

# Admin user IDs
admin_id = ["", "5515365946", "5669978367", "1213841794"]
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 1000:
                response = "Error: Time interval must be less than 350."
            else:
